...
namespace CSharpNeat
{
    class Indiv
    {
        ...
        public Indiv(int numInputNodes, int numOutputNodes, Random randin)
        {
            ...
            for (int i = 0; i < numInputNodes; i++)
            {
                for (int j = 0; j < numOutputNodes; j++)
                {
                    ...
                    Connection temp = new Connection(temp1, temp2, rand.NextDouble(), (i + j));
                    temp.IsEnabled = true;
        ...
        public int mutate(int innovNum)//uuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuhhhh idk how often we want these mutations to occur
        {
            ...
            else
            {
                ...
                Connection temp1 = new Connection(inputNode, outputNode, (2 * rand.NextDouble()) - 1, innovNum);
                connections.Add(temp1);
                innovNum++;
            }
            return innovNum;
